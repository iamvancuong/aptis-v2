...
@section('title', 'Thêm Thành tích - Admin')
@section('header', 'Thêm Học viên Bảng vàng')
...
<div class="max-w-3xl mx-auto">
    ...
    <form action="{{ route('admin.high-scores.store') }}" method="POST">
        @csrf
        ...
        <x-card title="Thông tin Thành tích">
            <div class="space-y-6">
                ...
                <x-input 
                    ...
                    hint="Dùng ảnh chụp chứng chỉ hoặc ảnh chân dung học viên."
                />
