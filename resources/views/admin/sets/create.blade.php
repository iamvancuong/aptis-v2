...
<x-card>
    <form action="{{ route('admin.sets.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="order" value="{{ old('order', 0) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            <p class="text-xs text-gray-400 mt-1">💡 Nếu vị trí đã có bộ đề khác, các bộ đề phía sau sẽ tự động dịch xuống.</p>
