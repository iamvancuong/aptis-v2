...
<form action="{{ route('admin.writing-sets.update', $writing_set) }}" method="POST" class="space-y-6 max-w-5xl" x-data="{ hasPart1: {{ old('has_part_1', $q1 ? true : false) ? 'true' : 'false' }}, hasPart2: {{ old('has_part_2', $q2 ? true : false) ? 'true' : 'false' }} }">
    @csrf
    @method('PUT')
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="space-y-3">
                ...
                <label class="flex items-center">
                    <input type="checkbox" class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500" name="has_part_1" value="1" {{ old('has_part_1', $q1 ? true : false) ? 'checked' : '' }} x-model="hasPart1">
                    <span class="ml-2 text-gray-600">Bộ đề này có bao gồm Part 1 (Form Filling)</span>
                </label>
                <label class="flex items-center">
                    <input type="checkbox" class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500" name="has_part_2" value="1" {{ old('has_part_2', $q2 ? true : false) ? 'checked' : '' }} x-model="hasPart2">
    ...
    <x-card title="Part 4: Formal and Informal Writing (Dual Email)" class="mb-6">
        <div class="space-y-6">
            ...
            <div class="space-y-4 border-t border-gray-100 pt-4">
                ...
                <x-input name="part4_task1_instruction" label="Yêu cầu Task 1" value="{{ old('part4_task1_instruction', $part4_task1_instruction ?: 'Write an email to your friend') }}" required error="{{ $errors->first('part4_task1_instruction') }}" />
            ...
            <div class="space-y-4 border-t border-gray-100 pt-4">
                ...
                <x-input name="part4_task2_instruction" label="Yêu cầu Task 2" value="{{ old('part4_task2_instruction', $part4_task2_instruction ?: 'Email to the manager of the club:') }}" required error="{{ $errors->first('part4_task2_instruction') }}" />
