            ...
            <aside class="fixed md:static inset-y-0 left-0 z-[100] bg-white shadow-lg transition-all duration-300 ease-in-out flex flex-col transform max-w-[80vw]"
                ...
                <nav class="flex-1 px-3 py-4 space-y-2 overflow-y-auto custom-scrollbar" x-data="{ 
                    ...
                    <div class="mb-4">
                        ...
                        <x-nav-link href="{{ route('admin.guidance-sessions.index') }}" :active="request()->routeIs('admin.guidance-sessions.*')" class="flex items-center mt-1" x-bind:class="{'justify-center px-0': (isDesktopCollapsed && !isMobile)}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                            </svg>
                            <span class="ml-3 font-medium whitespace-nowrap transition-opacity duration-300" :class="{'opacity-0 hidden': (isDesktopCollapsed && !isMobile), 'opacity-100 block': !(isDesktopCollapsed && !isMobile)}">Buổi hướng dẫn</span>
                        </x-nav-link>
