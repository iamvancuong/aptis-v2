...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
        ...
        {{-- Nút "gửi giáo viên chấm bài" đã TẮT HOÀN TOÀN (cả học viên lẫn admin).
             Writing giờ chỉ chấm bằng AI; không bài nào tự vào hàng chờ giáo viên.
             Speaking cũng đã tắt tự gửi (xem MockTestController::submit).
             Bật lại = đổi `false` dưới đây về điều kiện cũ:
             $mockTest->skill === 'writing' && $attempts->first()  --}}
        @if(false)
