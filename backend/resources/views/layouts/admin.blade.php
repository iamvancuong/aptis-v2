...
<body class="bg-gray-100">
    <div x-data="{ 
        ...
        <div x-show="isMobileOpen" 
             ...
             class="fixed inset-0 z-[90] bg-black bg-opacity-50 md:hidden"
             x-cloak>
        </div>

        <div class="flex h-screen overflow-hidden">
            <!-- Sidebar -->
            <aside :class="(isDesktopCollapsed && !isMobile) ? 'w-20' : 'w-64'"
                   class="fixed md:static inset-y-0 left-0 z-[100] bg-white shadow-lg transition-all duration-300 ease-in-out flex flex-col transform max-w-[80vw]"
                ...
                <nav class="flex-1 px-2 py-4 space-y-2 overflow-y-auto">
                    ...
                    <x-nav-link href="{{ route('admin.writing-reviews.index') }}" :active="request()->routeIs('admin.writing-reviews.*')" class="flex items-center" x-bind:class="{'justify-center px-0': isDesktopCollapsed}">
                        <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
