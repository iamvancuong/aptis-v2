    ...
    <x-card title="Part 1: Personal Information (Tùy chọn)" class="mb-6 border-l-4 border-indigo-500">
        <div class="space-y-4">
            <div class="space-y-4 border-t border-gray-100 pt-4">
                <x-input name="part1_q1" label="Câu hỏi 1" value="{{ old('part1_q1', $p1->metadata['questions'][0] ?? '') }}" error="{{ $errors->first('part1_q1') }}" />
                <x-input name="part1_q2" label="Câu hỏi 2" value="{{ old('part1_q2', $p1->metadata['questions'][1] ?? '') }}" error="{{ $errors->first('part1_q2') }}" />
                <x-input name="part1_q3" label="Câu hỏi 3" value="{{ old('part1_q3', $p1->metadata['questions'][2] ?? '') }}" error="{{ $errors->first('part1_q3') }}" />
            </div>
            <div class="mt-4">
