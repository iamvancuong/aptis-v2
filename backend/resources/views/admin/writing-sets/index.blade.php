        ...
        @forelse($sets as $set)
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm space-x-2">
                    ...
                    <form action="{{ route('admin.writing-sets.destroy', $set) }}" method="POST" class="inline-block" onsubmit="return confirm('Bạn có chắc xoá bộ đề này? Các câu trả lời thuộc bộ đề này cũng sẽ bị mất.')">
                        @csrf
                        @method('DELETE')
