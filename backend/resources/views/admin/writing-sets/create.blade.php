...
<form action="{{ route('admin.writing-sets.store') }}" method="POST" class="space-y-6 max-w-5xl">
    @csrf
    ...
    <x-card title="Part 4: Formal and Informal Writing (Dual Email)" class="mb-6">
        <div class="space-y-6">
            ...
            <div class="space-y-4 border-t border-gray-100 pt-4">
                ...
                <x-input name="part4_task1_instruction" label="Yêu cầu Task 1" placeholder="VD: Write an email to your friend explaining..." value="{{ old('part4_task1_instruction') }}" required error="{{ $errors->first('part4_task1_instruction') }}" />
            ...
            <div class="space-y-4 border-t border-gray-100 pt-4">
                ...
                <x-input name="part4_task2_instruction" label="Yêu cầu Task 2" placeholder="VD: Write an email to the management..." value="{{ old('part4_task2_instruction') }}" required error="{{ $errors->first('part4_task2_instruction') }}" />
