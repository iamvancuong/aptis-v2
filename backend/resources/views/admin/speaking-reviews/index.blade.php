...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto mt-4 md:mt-0 justify-end">
        <form action="{{ route('admin.speaking-reviews.index') }}" method="GET" class="flex flex-col md:flex-row gap-2 w-full md:w-auto">
            ...
            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 whitespace-nowrap text-sm font-medium">Lọc</button>
        </form>
